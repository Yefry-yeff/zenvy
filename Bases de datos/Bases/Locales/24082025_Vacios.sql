...
-- Tiempo de generación: 25-08-2025 a las 03:31:49
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_crud_producto` (IN `p_accion` INT, IN `p_id` INT, IN `p_nombre` VARCHAR(80), IN `p_descripcion` VARCHAR(45), IN `p_isv_id` INT, IN `p_precio_base` DOUBLE, IN `p_ultimo_costo_compra` DOUBLE, IN `p_costo_promedio` DOUBLE, IN `p_codigo_barra` VARCHAR(100), IN `p_codigo_estatal` VARCHAR(45), IN `p_estado_id` INT, IN `p_subcategoria_id` INT, IN `p_marca_id` INT, IN `p_unidad_medida_venta_id` INT, IN `p_precio1` DECIMAL(16,2), IN `p_precio2` DECIMAL(16,2), IN `p_precio3` DECIMAL(16,2), IN `p_precio4` DECIMAL(16,2), IN `p_users_id` BIGINT, IN `p_descuento_unitario` DECIMAL(16,2), IN `p_descuento_tercera` TINYINT, IN `p_descuento_cuarta` TINYINT, IN `p_imagen` LONGBLOB)   BEGIN
    ...
    ELSEIF p_accion = 4 THEN
        ...
        SELECT 
            ...
            p.precio1, p.precio2, p.precio3, p_precio4,
            p.imagen
        FROM producto p
...
CREATE TABLE `apertura_caja` (
  ...
  `balance_apertura` decimal(16,2) DEFAULT NULL,
...
CREATE TABLE `cierre_de_caja` (
  ...
  `diferencia_transferencia` decimal(16,2) DEFAULT NULL,
...
(1, 'Atlántida', 1, '2025-08-03 09:28:06', '2025-08-03 09:28:06'),
(2, 'Choluteca', 1, '2025-08-03 09:28:06', '2025-08-03 09:28:06'),
(3, 'Colon', 1, '2025-08-03 09:28:06', '2025-08-06 00:07:25'),
(4, 'Comayagua', 1, '2025-08-03 09:28:06', '2025-08-03 09:28:06'),
(5, 'Copán', 1, '2025-08-03 09:28:06', '2025-08-03 09:28:06'),
(6, 'Cortés', 1, '2025-08-03 09:28:06', '2025-08-03 09:28:06'),
(7, 'El Paraíso', 1, '2025-08-03 09:28:06', '2025-08-03 09:28:06'),
(8, 'Francisco Morazán', 1, '2025-08-03 09:28:06', '2025-08-03 09:28:06'),
(9, 'Gracias a Dios', 1, '2025-08-03 09:28:06', '2025-08-03 09:28:06'),
(10, 'Intibucá', 1, '2025-08-03 09:28:06', '2025-08-03 09:28:06'),
(11, 'Islas de la Bahía', 1, '2025-08-03 09:28:06', '2025-08-03 09:28:06'),
(12, 'La Paz', 1, '2025-08-03 09:28:06', '2025-08-03 09:28:06'),
(13, 'Lempira', 1, '2025-08-03 09:28:06', '2025-08-03 09:28:06'),
(14, 'Ocotepeque', 1, '2025-08-03 09:28:06', '2025-08-03 09:28:06'),
(15, 'Olancho', 1, '2025-08-03 09:28:06', '2025-08-03 09:28:06'),
(16, 'Santa Bárbara', 1, '2025-08-03 09:28:06', '2025-08-03 09:28:06'),
(17, 'Valle', 1, '2025-08-03 09:28:06', '2025-08-03 09:28:06'),
(18, 'Yoro', 1, '2025-08-03 09:28:06', '2025-08-03 09:28:06');
...
CREATE TABLE `descuentos` (
  ...
  `monto_unidad` decimal(16,2) DEFAULT NULL,
...
(1, 'Plaza Ventu', '', '', '', '', 3, 53, 1, '', '', '2025-08-13 14:26:54', '2025-08-13 14:26:54');
...
(3, 'Distribuido', '2025-08-07 05:30:50', NULL),
(4, 'Anulado', '2025-08-07 05:30:50', NULL),
(5, 'Pendiente', '2025-08-13 12:38:42', NULL);
...
(1, 'Activa', '2025-08-09 06:41:11', NULL),
(2, 'Anulada', '2025-08-09 06:41:17', NULL);
...
(1, '15.00', '2025-08-09 19:44:11', '2025-08-09 21:05:56', 1),
(2, '18.00', '2025-08-09 19:44:25', '2025-08-09 21:05:55', 1),
(5, '0.00', '2025-08-10 06:01:41', '2025-08-10 06:01:41', 1);
...
(10, 'Menú', 5, 'Menu.Index', 1, NULL, 1, '2025-07-23 14:31:58', '2025-07-23 14:30:35'),
(26, 'Usuarios', 5, 'Configuracion.Usuarios', 2, NULL, 1, '2025-07-25 03:40:38', '2025-07-24 10:33:54'),
(27, 'Roles', 5, 'Configuracion.Roles', 3, NULL, 1, '2025-07-25 04:22:05', '2025-07-25 04:22:05'),
(54, 'Sucursales', 3, 'GestionDeSucursales.Sucursales', 1, NULL, 1, NULL, '2025-07-30 00:59:51'),
(55, 'Apertura de Jornada', 3, 'GestionDeSucursales.AperturaDeJornada', 1, NULL, 1, NULL, '2025-07-30 01:00:35'),
(56, 'Cierre de Jornada', 3, 'gestion-de-sucursales.cierre-de-jornada', 1, NULL, 2, '2025-08-05 11:08:30', '2025-07-30 01:00:47'),
(58, 'Producto', 2, 'Inventario.Producto', 1, NULL, 1, NULL, '2025-07-30 01:41:41'),
(59, 'Ventas', 1, 'SalaDeVentas.Ventas', 1, NULL, 1, NULL, '2025-07-30 01:46:18'),
(63, 'Marca', 2, 'Inventario.Marca', 5, NULL, 1, '2025-08-07 03:04:29', '2025-07-30 09:37:55'),
(64, 'Categoria', 2, 'Inventario.Categoria', 6, NULL, 1, '2025-08-07 03:04:38', '2025-07-31 04:13:12'),
(67, 'Unidades de Medida', 2, 'Inventario.Presentaciones', 7, NULL, 1, '2025-08-07 03:04:44', '2025-08-01 08:49:26'),
(68, 'Cai', 9, 'Gestion.Cai', 1, NULL, 1, NULL, '2025-08-03 09:44:21'),
(70, 'Bodegas', 2, 'Inventario.Bodegas', 4, NULL, 1, '2025-08-07 03:03:49', '2025-08-04 01:05:59'),
(71, 'Cambio de Sucursal', 3, 'GestionDeSucursales.CambioDeSucursal', 2, NULL, 1, NULL, '2025-08-05 00:57:57'),
(72, 'Recibir en Bodega', 2, 'Inventario.RecibirEnBodega', 3, NULL, 2, '2025-08-08 00:01:50', '2025-08-05 01:43:24'),
(73, 'Actores', 1, 'SalaDeVentas.Clientes', 2, NULL, 1, NULL, '2025-08-05 10:57:53'),
(74, 'Cierre de Caja', 11, 'Caja.CierreDeCaja', 1, NULL, 1, NULL, '2025-08-05 11:01:56'),
(75, 'Departamento', 3, 'GestionDeSucursales.Departamento', 3, NULL, 1, NULL, '2025-08-05 22:06:38'),
(77, 'Compra de Productos', 2, 'Inventario.CompraDeProductos', 2, NULL, 1, NULL, '2025-08-07 07:22:32'),
(78, 'Entrega de Efectivo', 11, 'Caja.EntregaDeEfectivo', 2, NULL, 1, NULL, '2025-08-08 00:02:23'),
(79, 'Recibido de efectivo', 11, 'Caja.RecibidoDeEfectivo', 3, NULL, 1, NULL, '2025-08-08 00:04:56'),
(80, 'Empresa', 9, 'Gestion.Empresa', 2, NULL, 1, NULL, '2025-08-08 00:05:10'),
(81, 'Lista de Facturas', 1, 'SalaDeVentas.ListaDeFacturas', 1, NULL, 1, NULL, '2025-08-09 06:09:26'),
(82, 'ISV', 2, 'Inventario.Isv', 8, NULL, 1, NULL, '2025-08-09 20:45:24'),
(83, 'Apertura de Caja', 11, 'Caja.SaldoInicial', 1, NULL, 1, '2025-08-21 19:54:17', '2025-08-10 13:00:46'),
(84, 'Cierre de Jornada', 3, 'GestionDeSucursales.CierreDeJornada', 4, NULL, 1, NULL, '2025-08-10 20:15:18'),
(85, 'Gestion de Diferencias', 11, 'Caja.GestionDeDiferencias', 6, NULL, 1, NULL, '2025-08-10 23:47:38'),
(86, 'Lista de Productos', 2, 'Inventario.ListaDeProductos', 1, NULL, 1, NULL, '2025-08-13 01:32:50'),
(87, 'Servicios', 12, 'Catalogo.Servicios', 1, NULL, 2, '2025-08-23 01:57:12', '2025-08-19 03:24:32'),
(88, 'Flujo de Caja', 11, 'Caja.FlujoDeCaja', 1, NULL, 1, NULL, '2025-08-22 18:27:11');
...
(1, 'Sala de Ventas', '🛒', '2025-07-28 07:44:41', NULL),
(2, 'Inventario', '📦', '2025-07-28 07:44:47', '2025-08-08 00:01:50'),
(3, 'Gestion de Sucursales', '🏢', '2025-07-28 07:44:53', '2025-08-05 11:08:30'),
(5, 'Configuracion', '⚙️', '2025-07-28 07:45:00', '2025-07-28 09:51:16'),
(6, 'Gestion de Usuarios', '👤', '2025-07-28 10:02:53', NULL),
(7, 'Gestion Cai', '🧾', '2025-07-30 00:23:02', NULL),
(8, 'Gestiones Cai', '🧾', '2025-07-30 01:36:20', '2025-08-03 09:45:05'),
(9, 'Gestion', '🧾', '2025-08-03 09:44:21', NULL),
(10, 'Prueba', '📂', '2025-08-03 09:58:40', '2025-08-05 11:02:11'),
(11, 'Caja', '🗃️', '2025-08-05 11:01:56', '2025-08-21 19:54:17'),
(12, 'Catalogo', '💼', '2025-08-19 03:24:32', '2025-08-23 01:57:12');
...
(1, 'La Ceiba', 1, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(2, 'Tela', 1, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(3, 'Jutiapa', 1, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(4, 'La Masica', 1, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(5, 'Arizona', 1, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(7, 'Tocoa', 2, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(8, 'Bonito Oriental', 2, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(9, 'Sabá', 2, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(10, 'Iriona', 2, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(11, 'Comayagua', 3, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(12, 'La Libertad', 3, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(13, 'Esquías', 3, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(14, 'Lejamaní', 3, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(15, 'San Jerónimo', 3, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(16, 'Santa Rosa de Copán', 4, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(17, 'La Entrada', 4, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(18, 'Copán Ruinas', 4, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(19, 'Florida', 4, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(20, 'Dulce Nombre', 4, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(21, 'Choluteca', 5, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(22, 'Pespire', 5, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(23, 'San Marcos de Colón', 5, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(24, 'El Triunfo', 5, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(25, 'Namasigüe', 5, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(26, 'San Pedro Sula', 6, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(27, 'Choloma', 6, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(28, 'Puerto Cortés', 6, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(29, 'Villanueva', 6, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(30, 'La Lima', 6, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(31, 'Danlí', 7, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(32, 'Yuscarán', 7, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(33, 'Teupasenti', 7, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(34, 'Trojes', 7, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(35, 'Jacaleapa', 7, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(36, 'Distrito Central', 8, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(37, 'Valle de Ángeles', 8, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(38, 'Tatumbla', 8, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(39, 'Guaimaca', 8, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(40, 'Ojojona', 8, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(41, 'Puerto Lempira', 9, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(42, 'Brus Laguna', 9, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(43, 'Ahuas', 9, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(44, 'Juan Francisco Bulnes', 9, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(45, 'Villeda Morales', 9, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(46, 'La Esperanza', 10, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(47, 'Intibucá', 10, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(48, 'Camasca', 10, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(49, 'Colomoncagua', 10, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(50, 'San Francisco de Opalaca', 10, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(51, 'Roatán', 11, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(52, 'Utila', 11, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(53, 'Guanaja', 11, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(54, 'La Paz', 12, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(55, 'Marcala', 12, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(56, 'Cabañas', 12, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(57, 'Santa Ana', 12, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(58, 'San José', 12, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(59, 'Gracias', 13, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(60, 'Erandique', 13, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(61, 'La Campa', 13, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(62, 'La Iguala', 13, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(63, 'San Manuel Colohete', 13, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(64, 'Ocotepeque', 14, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(65, 'Sensenti', 14, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(66, 'La Labor', 14, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(67, 'Lucerna', 14, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(68, 'Sinuapa', 14, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(69, 'Juticalpa', 15, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(70, 'Catacamas', 15, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(71, 'Campamento', 15, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(72, 'San Francisco de la Paz', 15, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(73, 'Gualaco', 15, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(74, 'Santa Bárbara', 16, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(75, 'Macuelizo', 16, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(76, 'San Luis', 16, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(77, 'Quimistán', 16, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(78, 'Atima', 16, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(79, 'Nacaome', 17, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(80, 'San Lorenzo', 17, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(81, 'Amapala', 17, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(82, 'Caridad', 17, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(83, 'Goascorán', 17, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(84, 'Yoro', 18, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(85, 'El Progreso', 18, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(86, 'Olanchito', 18, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(87, 'Morazán', 18, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(88, 'Victoria', 18, 1, '2025-08-03 09:30:35', '2025-08-03 09:30:35'),
(89, 'Trujillo', 2, 1, '2025-08-06 00:23:36', '2025-08-06 00:23:36');
...
(1, 'Administrador', 1, '2025-08-13 03:16:00', NULL, '2025-07-24 16:09:00', 1),
(2, 'Admin', 1, '2025-07-24 21:14:09', NULL, '2025-07-24 21:14:09', 1),
(3, 'Inventario', 1, '2025-08-10 15:07:49', NULL, '2025-08-04 15:40:09', 1),
(4, 'Supervisor', 1, '2025-08-10 15:26:31', NULL, '2025-08-10 15:05:56', 1),
(5, 'Cajero', 1, '2025-08-10 15:06:43', NULL, '2025-08-10 15:06:43', 1);
...
(20, 1, 1, NULL, NULL, '2025-08-13 03:16:00', 1, 73),
(21, 1, 1, NULL, NULL, '2025-08-13 03:16:00', 1, 81),
(22, 1, 1, NULL, NULL, '2025-08-13 03:16:00', 1, 59),
(23, 1, 1, NULL, NULL, '2025-08-13 03:16:00', 1, 82),
(24, 1, 1, NULL, NULL, '2025-08-13 03:16:00', 1, 63),
(25, 1, 1, NULL, NULL, '2025-08-13 03:16:00', 1, 67),
(26, 1, 1, NULL, NULL, '2025-08-13 03:16:00', 1, 77),
(27, 1, 1, NULL, NULL, '2025-08-13 03:16:00', 1, 64),
(28, 1, 1, NULL, NULL, '2025-08-13 03:16:00', 1, 70),
(29, 1, 1, NULL, NULL, '2025-08-13 03:16:00', 1, 58),
(30, 1, 1, NULL, NULL, '2025-08-13 03:16:00', 1, 86),
(31, 1, 1, NULL, NULL, '2025-08-13 03:16:00', 1, 84),
(32, 1, 1, NULL, NULL, '2025-08-13 03:16:00', 1, 71),
(33, 1, 1, NULL, NULL, '2025-08-13 03:16:00', 1, 75),
(34, 1, 1, NULL, NULL, '2025-08-13 03:16:00', 1, 55),
(35, 1, 1, NULL, NULL, '2025-08-13 03:16:00', 1, 68),
(36, 1, 1, NULL, NULL, '2025-08-13 03:16:00', 1, 80),
(37, 1, 1, NULL, NULL, '2025-08-13 03:16:00', 1, 85),
(38, 1, 1, NULL, NULL, '2025-08-13 03:16:00', 1, 78),
(39, 1, 1, NULL, NULL, '2025-08-13 03:16:00', 1, 74),
(40, 1, 1, NULL, NULL, '2025-08-13 03:16:00', 1, 83),
(41, 1, 1, NULL, NULL, '2025-08-13 03:16:00', 1, 79);
...
CREATE TABLE `servicios` (
  ...
  `descuento_unitario` decimal(16,2) DEFAULT '0.00',
  `descuento_tercera` tinyint(1) DEFAULT NULL,
  `descuento_cuarta` tinyint(1) DEFAULT NULL,
  `precio_base` decimal(16,2) DEFAULT NULL,
  `isv_id` int(11) NOT NULL,
  `estado_id` int(11) NOT NULL,
  `users_id` bigint(20) UNSIGNED NOT NULL,
  `imagen` longblob,
...
('sG4YVHTQQdRZwMQX2jtDiZh7Jk7U3k72nd3ZqCBH', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/139.0.0.0 Safari/537.36', '', 1756092641);
...
(1, 'Prueba', 'test', '2222-2222', '9999-9999', 'test@gmail.com', 1, 1, 1, '', 'ICS-0004', 1, '2025-08-13 14:26:54', '2025-08-13 14:26:54', 1);
...
(1, 'Cliente A', '2025-08-06 08:22:48', NULL),
(2, 'Cliente B', '2025-08-06 08:22:48', NULL),
(3, 'Proveedor', '2025-08-07 03:11:53', NULL);
...
(1, 'Cliente', '2025-08-03 09:22:27', '2025-08-03 09:22:27'),
(2, 'Proveedor', '2025-08-03 09:22:27', '2025-08-03 09:22:27'),
(3, 'Tienda', '2025-08-03 09:23:22', '2025-08-03 09:23:22'),
(4, 'Usuario', '2025-08-03 09:23:22', '2025-08-03 09:23:22');
...
(1, '01-Factura', '2025-08-03 09:21:50', '2025-08-03 09:21:50', 1, 1);
...
(1, 'Efectivo', '2025-08-08 11:12:57', NULL),
(2, 'Tarjeta(POS)', '2025-08-08 11:12:57', NULL),
(3, 'Cheque', '2025-08-08 11:13:40', NULL),
(4, 'Transferencia', '2025-08-11 20:43:06', NULL);
...
(1, 'Natural', '2025-08-06 08:23:26', NULL),
(2, 'Juridica', '2025-08-06 08:23:26', NULL);
...
(1, 'Principal', 1, '2025-08-03 09:20:56', '2025-08-03 09:20:56'),
(2, 'Sucursal', 1, '2025-08-03 09:20:56', '2025-08-03 09:20:56');
...
CREATE TABLE `transaccion` (
  ...
  `transferencia` decimal(16,2) DEFAULT NULL,
...
(1, 'Admin Sistemas', 'zenvyadmin@cadss.hn', NULL, '$2y$12$livSd0/GkJtyXe0zcyT0SOpAsn4dhLlekBrHkYMVrrsglc5BB05nG', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 1, 1, '2025-08-12 20:02:04', '2025-08-13 14:35:48'),
(4, 'Administrador  Sistema', 'Administrador@Administrador.com', NULL, '$2y$12$zVSnyw5PReTZwS8WMecJduwBiFpKGF4oS5n29b1o6.OCVwX74tzi6', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, 1, '2025-08-13 14:32:30', '2025-08-13 14:32:30');
...
(4, 'Admin', NULL, 'Sistemas', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Admin', 1, 1, '2025-08-13 14:29:31', '2025-08-13 14:35:48'),
(5, 'Administrador', NULL, ' Sistema', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0801ADMIN', 4, 1, '2025-08-13 14:32:30', '2025-08-13 14:32:30');
...
ALTER TABLE `apertura_caja`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_apertura_caja_caja1_idx` (`caja_id`),
  ADD KEY `fk_apertura_caja_transaccion1_idx` (`transaccion_id`);
...
ALTER TABLE `cierre_de_caja`
  ...
  ADD KEY `fk_cierre_de_caja_transaccion1_idx` (`transaccion_id`);
...
ALTER TABLE `compra_has_producto`
  ...
  ADD KEY `fk_Compra_has_producto_unidad_medida1_idx` (`unidad_medida_id`);
...
ALTER TABLE `descuentos`
  ...
  ADD KEY `fk_descuentos_factura1_idx` (`factura_id`),
  ADD KEY `fk_descuentos_producto1_idx` (`producto_id`),
  ADD KEY `fk_descuentos_Servicios1_idx` (`Servicios_id`);
...
ALTER TABLE `factura`
  ...
  ADD KEY `fk_factura_transaccion1_idx` (`transaccion_id`);
...
ALTER TABLE `factura_has_producto`
  ...
  ADD KEY `fk_factura_has_producto_Servicios1_idx` (`Servicios_id`);
...
ALTER TABLE `recibido_bodega`
  ...
  ADD KEY `fk_recibido_bodega_unidad_medida1_idx` (`unidad_medida_id`);
...
ALTER TABLE `servicios`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_Servicios_estado1_idx` (`estado_id`),
  ADD KEY `fk_Servicios_isv1_idx` (`isv_id`),
  ADD KEY `fk_Servicios_users1_idx` (`users_id`);
...
--
-- AUTO_INCREMENT de la tabla `factura_has_producto`
--
ALTER TABLE `factura_has_producto`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `apertura_caja`
  ADD CONSTRAINT `fk_apertura_caja_caja1` FOREIGN KEY (`caja_id`) REFERENCES `caja` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_apertura_caja_transaccion1` FOREIGN KEY (`transaccion_id`) REFERENCES `transaccion` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `cierre_de_caja`
  ...
  ADD CONSTRAINT `fk_cierre_de_caja_transaccion1` FOREIGN KEY (`transaccion_id`) REFERENCES `transaccion` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `compra_has_producto`
  ...
  ADD CONSTRAINT `fk_Compra_has_producto_unidad_medida1` FOREIGN KEY (`unidad_medida_id`) REFERENCES `unidad_medida` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `descuentos`
  ADD CONSTRAINT `fk_descuentos_Servicios1` FOREIGN KEY (`Servicios_id`) REFERENCES `servicios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_descuentos_factura1` FOREIGN KEY (`factura_id`) REFERENCES `factura` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_descuentos_producto1` FOREIGN KEY (`producto_id`) REFERENCES `producto` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
ALTER TABLE `factura`
  ...
  ADD CONSTRAINT `fk_factura_transaccion1` FOREIGN KEY (`transaccion_id`) REFERENCES `transaccion` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
ALTER TABLE `factura_has_producto`
  ADD CONSTRAINT `fk_factura_has_producto_Servicios1` FOREIGN KEY (`Servicios_id`) REFERENCES `servicios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
ALTER TABLE `recibido_bodega`
  ...
  ADD CONSTRAINT `fk_recibido_bodega_unidad_medida1` FOREIGN KEY (`unidad_medida_id`) REFERENCES `unidad_medida` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
ALTER TABLE `servicios`
  ADD CONSTRAINT `fk_Servicios_estado1` FOREIGN KEY (`estado_id`) REFERENCES `estado` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Servicios_isv1` FOREIGN KEY (`isv_id`) REFERENCES `isv` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Servicios_users1` FOREIGN KEY (`users_id`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
