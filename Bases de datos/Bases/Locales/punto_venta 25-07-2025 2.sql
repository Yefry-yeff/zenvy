...
-- Tiempo de generación: 25-07-2025 a las 22:56:07
...
(28, 'Prueba', 'NULL', 5, 'configuración.prueba', 5, '2025-07-25 17:17:30', '2025-07-24 22:53:03', 1),
(29, 'Pruebas1', 'X', 5, 'configuración.pruebas1', 7, '2025-07-25 17:18:04', '2025-07-24 22:58:38', 1);
...
(4, 'Joma', 'Johann S.', 'Perez', 'Quiroz', 'Kennedy', '99999999', 1, '2025-07-25 21:23:42', NULL, '2025-07-25 21:23:42', NULL, '2025-01-17', 'Masculino', '08011997170626'),
(5, 'Pedrito', NULL, 'Bleinsz', NULL, NULL, NULL, 1, '2025-07-25 21:40:54', NULL, '2025-07-25 21:40:54', NULL, NULL, 'Masculino', '111111111'),
(6, 'Johann', NULL, 'Ruiz', NULL, NULL, NULL, 1, '2025-07-25 21:49:14', NULL, '2025-07-25 21:49:14', NULL, NULL, NULL, '00000000');
...
(4, 29, 'Pruebas1', 1, '2025-07-25 11:18:04', 1, '2025-07-24 16:58:38', 1),
...
(1, 'Administrador', 1, '2025-07-25 11:19:09', NULL, '2025-07-24 16:09:00', 1),
...
(6, 1, 1, 1, '2025-07-25 09:00:38', NULL, '2025-07-25 09:00:38', NULL),
(7, 3, 5, 1, '2025-07-25 10:46:05', NULL, '2025-07-25 10:46:05', NULL),
(8, 1, 4, 1, '2025-07-25 11:19:09', NULL, '2025-07-25 11:19:09', NULL),
(9, 3, 1, 1, '2025-07-25 11:23:08', NULL, '2025-07-25 11:23:08', NULL),
(10, 3, 2, 1, '2025-07-25 11:23:08', NULL, '2025-07-25 11:23:08', NULL);
...
('9BPfjkzdDjkRAXvUUyYjiQHawTWwOJ935pm39Plf', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoiUk9iWnNkRlZXMEY0S1doMnNpNUJKN04ycUg2RGxva1o3MDdyQVNSOSI7czo2OiJfZmxhc2giO2E6Mjp7czozOiJvbGQiO2E6MDp7fXM6MzoibmV3IjthOjA6e319czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6Mjc6Imh0dHA6Ly8xMjcuMC4wLjE6ODAwMC9sb2dpbiI7fX0=', 1753484121);
...
(1, 'Johann Ruiz', 'johann_ruiz14@hotmail.com', NULL, '$2y$12$u9JTaSsTPhURqlnk06MKheQ60NXbYqxTdtb5yq7/xM0nwE1/6JBYq', NULL, NULL, 'xVHNq2GcZtDqC95b7IgqAV3gK6gdpqyENchoiF5YGtinO3OqnHDlj413v5UX', NULL, NULL, '2025-07-16 14:04:56', '2025-07-16 14:04:56', 1, NULL, NULL, 1),
...
(3, 'Joma Johann S. Perez Quiroz', 'joma10000@gmail.com', NULL, '$2y$12$TBDMmgyN3kEOq7M.ZgZtZ.jFwMEvHyY9l6UY7a67aq/zHEkLXafry', NULL, NULL, NULL, NULL, NULL, '2025-07-25 21:23:42', '2025-07-25 21:23:42', 1, NULL, NULL, 4),
(4, 'Pedrito  Bleinsz', 'pp@gmail.com', NULL, '$2y$12$t4svU7SZvo.8v69xYVGDxe5zSQhtrZoipJMwPWNMXPfaRjga5EVM6', NULL, NULL, NULL, NULL, NULL, '2025-07-25 21:40:54', '2025-07-25 21:40:54', 1, NULL, NULL, 5),
(5, 'Johann  Ruiz', 'hh@gmail.com', NULL, '$2y$12$bIvtztRz0EiIf0jAH2yDielI.j2rlBU1uaMabv53Q3EppyDA7Mmjm', NULL, NULL, NULL, NULL, NULL, '2025-07-25 21:49:14', '2025-07-25 21:50:50', 1, NULL, NULL, 6);
...
CREATE TABLE `user_permiso` (
  ...
  `user_id` bigint(20) UNSIGNED NOT NULL,
  `permiso_id` bigint(20) UNSIGNED NOT NULL,
  `id_usuario_creacion` bigint(20) UNSIGNED DEFAULT NULL,
  `id_usuario_modificacion` bigint(20) UNSIGNED DEFAULT NULL,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
...
(1, 1, 3, 1, NULL, NULL, '2025-07-24 16:09:09', 1),
(2, 3, 1, 1, NULL, NULL, '2025-07-25 15:23:42', NULL),
(3, 4, 1, 1, NULL, NULL, '2025-07-25 15:40:54', NULL),
(4, 5, 1, 1, NULL, NULL, '2025-07-25 15:49:14', NULL);
...
ALTER TABLE `rol_permiso`
  ...
  ADD KEY `fk_rol_permiso` (`permiso_id`);
...
ALTER TABLE `user_permiso`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_user_permiso` (`user_id`,`permiso_id`),
  ADD KEY `fk_userpermiso_permiso` (`permiso_id`);
...
--
ALTER TABLE `rol_permiso`
  ADD CONSTRAINT `fk_rol_permiso` FOREIGN KEY (`permiso_id`) REFERENCES `permisos` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `user_permiso`
  ADD CONSTRAINT `fk_userpermiso_permiso` FOREIGN KEY (`permiso_id`) REFERENCES `permisos` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_userpermiso_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
