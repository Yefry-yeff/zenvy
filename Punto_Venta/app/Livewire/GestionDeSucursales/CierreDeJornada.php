        ...
        try {
            ...
            foreach ($this->cajasAbiertas as $cajaData) {
                ...
                $idTransaccion = DB::table('transaccion')->insertGetId([
                    ...
                    'efectivo' => 0.00, // Valores en 0 para cierre de jornada
                    'tarjeta' => 0.00,   // Valores en 0 para cierre de jornada
                    'cheque' => 0.00,     // Valores en 0 para cierre de jornada
                    'transferencia' => 0.00, // Valores en 0 para cierre de jornada
