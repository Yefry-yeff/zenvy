...
class Ai extends Component
{
    ...
    private function obtenerEsquemaTablas()
    {
        ...
        $esquema .= "Columnas: id, numero_factura, cai, numero_secuencia_cai, nombre_cliente, rtn, sub_total, sub_total_grabado, sub_total_exento, isv, total, credito, dias_credito, fecha_emision, fecha_vencimiento, cai_id, tipo_facturacion_id, comentario, porc_descuento, monto_descuento, descuento_gravado, descuento_exento, precio_dolar, users_id, estado_factura_id, created_at, updated_at\n";
