...
class ReporteDeVentas extends Component
{
    ...
    {
        $facturas = app(FacturaTotalesService::class)->aplicar($this->buildQuery()->get());

        return app(FacturaTotalesService::class)->sumar($facturas);
    }
    ...
    {
        try {
            $servicio = app(FacturaTotalesService::class);
            $facturas = $servicio->aplicar($this->buildQuery()->get());
            $totales  = $servicio->sumar($facturas);
    ...
    public function render()
    {
        ...
        app(FacturaTotalesService::class)->aplicar($facturas->getCollection());
