...
class ListaDeFacturas extends Component
{
    ...
    public function verDetalle($facturaId)
    {
        ...
        if (!$this->facturaDetalle) {
            $this->totalesFacturaDetalle = [];
            return;
        }

        app(FacturaTotalesService::class)->aplicar(collect([$this->facturaDetalle]));

        $this->totalesFacturaDetalle = [
            'descuentos' => (float) $this->facturaDetalle->reporte_descuento,
            'descuento_gravado' => (float) $this->facturaDetalle->reporte_descuento_gravado,
            'descuento_exento' => (float) $this->facturaDetalle->reporte_descuento_exento,
            'subtotal_exento' => (float) $this->facturaDetalle->reporte_subtotal_exento,
            'total_exento' => (float) $this->facturaDetalle->reporte_exento,
            'subtotal_gravado' => (float) $this->facturaDetalle->reporte_subtotal_gravado,
            'total_gravado' => (float) $this->facturaDetalle->reporte_gravado,
            'total_gravado_18' => (float) $this->facturaDetalle->reporte_gravado_18,
            'subtotal' => (float) $this->facturaDetalle->reporte_gravado
                + (float) $this->facturaDetalle->reporte_exento,
            'isv_15' => (float) $this->facturaDetalle->reporte_isv_15,
            'isv_18' => (float) $this->facturaDetalle->reporte_isv_18,
            'total' => (float) $this->facturaDetalle->total,
        ];
    }
