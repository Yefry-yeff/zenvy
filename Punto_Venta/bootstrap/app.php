...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withMiddleware(function (Middleware $middleware) {
        ...
        // Middleware para API
        $middleware->alias([
            'api.auth' => \App\Http\Middleware\Api\ApiKeyAuth::class,
            'api.audit' => \App\Http\Middleware\Api\AuditApiRequest::class,
            'api.rate.limit' => \App\Http\Middleware\Api\RateLimitApi::class,
        ]);
    })
