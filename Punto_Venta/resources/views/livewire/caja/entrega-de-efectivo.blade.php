<div class="min-h-screen p-6 bg-gradient-to-br from-red-50 via-white to-orange-50">
    <div class="max-w-4xl mx-auto">
                ...
                <div class="p-6 bg-white border border-gray-200 shadow-lg rounded-2xl">
                    ...
                    <form wire:submit="entregarEfectivo" class="space-y-6">
                        ...
                        <div class="flex pt-4 space-x-4">
                            <button type="submit"
                                    @if(!$cajaActual) disabled @endif
                                    class="flex items-center justify-center flex-1 px-6 py-3 space-x-2 font-semibold text-white transition-colors duration-200 bg-red-600 rounded-lg hover:bg-red-700 disabled:bg-gray-400 disabled:cursor-not-allowed">
        ...
        <div class="p-6 mt-6 border border-orange-200 bg-orange-50 rounded-2xl">
            <h3 class="flex items-center mb-3 text-lg font-semibold text-orange-800">
                <svg class="w-5 h-5 mr-2 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                </svg>
                Información Importante
            </h3>
            <div class="grid grid-cols-1 gap-4 text-sm text-orange-700 md:grid-cols-2">
