<div class="min-vh-100 bg-light">
    <div class="container-fluid">
        ...
        <div class="row py-3 border-bottom bg-white mb-3">
            <div class="col-12">
            ...
            <div class="col-md-6">
                <div class="card h-100">
                    ...
                    <div class="card-body" style="overflow-y: auto; max-height: 80vh;">
                        <div class="thermal-receipt" style="width: 100%; max-width: 400px; margin: 0 auto; background: white; padding: 20px; font-family: 'Courier New', monospace; font-size: 12px; line-height: 1.2; border: 1px solid #ddd;">
