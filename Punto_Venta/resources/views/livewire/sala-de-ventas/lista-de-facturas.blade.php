                        ...
                        <div class="mt-3 row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="text-center row align-items-stretch">
                                            <div class="col-md-4">
                                                <div class="border-right">
                                                    <h6 class="text-muted">Subtotal exento</h6>
                                                    <h5 class="text-dark">L. {{ number_format($totalesFacturaDetalle['subtotal_exento'] ?? 0, 2) }}</h5>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="border-right">
                                                    <h6 class="text-muted">Descuento exento</h6>
                                                    <h5 class="text-danger">-L. {{ number_format($totalesFacturaDetalle['descuento_exento'] ?? 0, 2) }}</h5>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <h6 class="text-muted">Total exento</h6>
                                                <h5 class="text-dark font-weight-bold">L. {{ number_format($totalesFacturaDetalle['total_exento'] ?? 0, 2) }}</h5>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="text-center row align-items-stretch">
                                            <div class="col-md-4">
                                                <div class="border-right">
                                                    <h6 class="text-muted">Subtotal gravado</h6>
                                                    <h5 class="text-dark">L. {{ number_format($totalesFacturaDetalle['subtotal_gravado'] ?? 0, 2) }}</h5>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="border-right">
                                                    <h6 class="text-muted">Descuento gravado</h6>
                                                    <h5 class="text-danger">-L. {{ number_format($totalesFacturaDetalle['descuento_gravado'] ?? 0, 2) }}</h5>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <h6 class="text-muted">Total gravado</h6>
                                                <h5 class="text-dark font-weight-bold">L. {{ number_format($totalesFacturaDetalle['total_gravado'] ?? 0, 2) }}</h5>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="text-center row align-items-stretch">
                                            <div class="{{ ($totalesFacturaDetalle['total_gravado_18'] ?? 0) > 0 || ($totalesFacturaDetalle['isv_18'] ?? 0) > 0 ? 'col-md-3' : 'col-md-4' }}">
                                                <div class="border-right">
                                                    <h6 class="text-muted">Subtotal</h6>
                                                    <h5 class="text-dark">L. {{ number_format($totalesFacturaDetalle['subtotal'] ?? 0, 2) }}</h5>
                                                </div>
                                            </div>
                                            <div class="{{ ($totalesFacturaDetalle['total_gravado_18'] ?? 0) > 0 || ($totalesFacturaDetalle['isv_18'] ?? 0) > 0 ? 'col-md-3' : 'col-md-4' }}">
                                                <div class="border-right">
                                                    <h6 class="text-muted">Impuesto del 15%</h6>
                                                    <h5 class="text-dark">L. {{ number_format($totalesFacturaDetalle['isv_15'] ?? 0, 2) }}</h5>
                                                </div>
                                            </div>
                                            @if(($totalesFacturaDetalle['total_gravado_18'] ?? 0) > 0 || ($totalesFacturaDetalle['isv_18'] ?? 0) > 0)
                                                <div class="col-md-3">
                                                    <div class="border-right">
                                                        <h6 class="text-muted">Impuesto del 18%</h6>
                                                        <h5 class="text-dark">L. {{ number_format($totalesFacturaDetalle['isv_18'] ?? 0, 2) }}</h5>
                                                    </div>
                                                </div>
                                            @endif
                                            <div class="{{ ($totalesFacturaDetalle['total_gravado_18'] ?? 0) > 0 || ($totalesFacturaDetalle['isv_18'] ?? 0) > 0 ? 'col-md-3' : 'col-md-4' }}">
                                                <h6 class="text-muted">Total</h6>
                                                <h5 class="text-dark font-weight-bold">L. {{ number_format($totalesFacturaDetalle['total'] ?? 0, 2) }}</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
